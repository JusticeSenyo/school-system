...
import SupportTicketDialog from "../support/SupportTicketDialog"; // ✅ NEW
...
const DashboardLayout = ({ title = "Dashboard", subtitle = "", children }) => {
  ...
  const [supportOpen, setSupportOpen] = useState(false); // ✅ NEW
        ...
        >
          <div className="flex flex-col h-full overflow-y-auto">
            ...
            <Sidebar
              ...
              role={role}
              menus={menusForRole}
              onContactSupport={() => setSupportOpen(true)} // ✅ NEW
            />
          </div>
        </div>
